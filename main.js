...
const tasks = (() => {
  ...
  const openForm = (id = "") => {
    if (id) {
      _forms__WEBPACK_IMPORTED_MODULE_2__["default"].openTaskForm(id);
    } else {
  ...
  const selectProject = (parent, task = "", projects) => {
    ...
    projects.forEach((project) => {
      if (project.id === selected.attributes[1].value) {
        ...
        Object(_helpers_index__WEBPACK_IMPORTED_MODULE_0__["maker"])("option", { value: project.id, selected }, "No Project", select);
      } else {
...
const sidenav = (() => {
  ...
  const getTasksIndex = () => {
    ...
    newProjects.length > 0 ? render(newProjects) : _views_sidenavViews__WEBPACK_IMPORTED_MODULE_2__["default"].renderWelcome();
