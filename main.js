...
const app = (() => {
  ...
  const renderIndex = () => {
    ...
    let projects = _helpers_store__WEBPACK_IMPORTED_MODULE_4__["default"].getProjects();
    _controllers_sidenav__WEBPACK_IMPORTED_MODULE_3__["default"].renderCounts();
    _controllers_projects__WEBPACK_IMPORTED_MODULE_2__["default"].render(projects);
...
const tasks = (() => {
  ...
  const update = (data) => {
    ...
    project === "0"
      ...
      : _app__WEBPACK_IMPORTED_MODULE_0__["default"].render(_helpers_store__WEBPACK_IMPORTED_MODULE_3__["default"].findProject(project));
  };
...
const taskViews = (() => {
  ...
  const renderDropdown = (parent) => {
    ...
    let div = Object(_helpers_index__WEBPACK_IMPORTED_MODULE_2__["maker"])("div", { class: "dropdown" }, "", parent);
    let edit = Object(_helpers_index__WEBPACK_IMPORTED_MODULE_2__["maker"])("button", { class: "dropdown-button" }, "Edit Task", div);
  ...
  const renderTaskExpanded = (parent, task) => {
    ...
    Object(_helpers_index__WEBPACK_IMPORTED_MODULE_2__["maker"])("p", { class: "details-description" }, task.description, div);
  };
  ...
  const renderTaskCollapsed = (parent, task) => {
    ...
    let clickArea = Object(_helpers_index__WEBPACK_IMPORTED_MODULE_2__["maker"])("div", { class: "task-click-area" }, "", div);

    let button = Object(_helpers_index__WEBPACK_IMPORTED_MODULE_2__["maker"])(
      "button",
      { class: `complete-button ${task.priority}` },
      "",
      div
    );
    Object(_helpers_index__WEBPACK_IMPORTED_MODULE_2__["maker"])("i", { class: "fas fa-check checkmark hidden" }, "", button);

    let info = Object(_helpers_index__WEBPACK_IMPORTED_MODULE_2__["maker"])("div", { class: "task-info" }, "", div);
    Object(_helpers_index__WEBPACK_IMPORTED_MODULE_2__["maker"])("h2", { class: "task-name" }, task.title, info);
    Object(_helpers_index__WEBPACK_IMPORTED_MODULE_2__["maker"])("p", { class: "task-date" }, task.date, info);

    let btn = Object(_helpers_index__WEBPACK_IMPORTED_MODULE_2__["maker"])("button", { class: "edit-task-button hidden" }, "", div);
    Object(_helpers_index__WEBPACK_IMPORTED_MODULE_2__["maker"])("i", { class: "fas fa-ellipsis-h" }, "", btn);
  ...
  const renderTask = (task) => {
    let div = Object(_helpers_index__WEBPACK_IMPORTED_MODULE_2__["maker"])("div", { class: "task-box", data: task.id }, "", main);
  ...
  const render = (project) => {
    if (project.tasks.length == 0) {
      ...
      Object(_helpers_index__WEBPACK_IMPORTED_MODULE_2__["maker"])("i", { class: "fas fa-plus" }, "", button);
...
const projectViews = (() => {
  ...
  const renderProjectHeader = (project) => {
    ...
    Object(_helpers_index__WEBPACK_IMPORTED_MODULE_2__["maker"])("h2", { class: "project-heading" }, project.name, div);
    if (project.id !== "0") {
